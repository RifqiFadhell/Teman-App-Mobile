...
@Composable
fun WeightTextFormField(
    value: Int = 0, onSelected: (Int) -> Unit,
    errorMessage: String? = null
) {
    val currentYearList by remember { mutableStateOf(weightList) }
    ...
    Column(
        ...
        Text("Total Perkiraan Berat Barang", style = UiFont.poppinsP2Medium)
